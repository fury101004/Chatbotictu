...
from services.vector_store_service import add_documents, smart_chunk
...
""".strip()
        ...
        with (
            patch("services.vector_store_service.get_collection", return_value=collection),
            patch("services.vector_store_service._rebuild_bm25"),
            patch("services.vector_store_service.inject_bot_rule"),
            patch("services.vector_store_service.count_tokens", side_effect=lambda value: len(value.split())),
