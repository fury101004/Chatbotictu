        ...
        "knowledge_flows": [
            {
                ...
                "steps": [
                    "Nguồn vào là `data/primary_corpus` hoặc file `.md/.txt` được upload theo từng nhóm tri thức.",
...
def _build_report_markdown(payload: dict) -> str:
    ...
    lines = [
        ...
        "",
        f"- Corpus tri thức gốc nằm tại `data/primary_corpus` với {dataset_report['total_samples']} file.",
        ...
        "",
        "- Nguồn tri thức đi vào từ seed corpus `data/primary_corpus` hoặc file upload `.md/.txt` theo từng nhóm tool.",
