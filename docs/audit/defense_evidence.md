...
| Ingestion jobs | `repositories/ingestion_repository.py::IngestionJobRepository`; `services/ingestion_queue.py::IngestionQueue` | `tests/test_ingestion_queue.py` | Queue completion/failure/not-found/restart interruption pass | Job dang chay khi process restart duoc danh dau `interrupted`; payload file dang cho khong duoc tiep tuc tu dong. |
