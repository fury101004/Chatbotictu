...
Chatbot cần trả lời các câu hỏi liên quan đến ICTU cho người học qua 4 RAG tool độc lập:

- `student_handbook_rag`: sổ tay sinh viên, hướng dẫn, thông tin theo khóa và năm học.
- `academic_policy_rag`: quy định, thông báo, quyết định, văn bản chính sách học vụ.
- `student_faq_rag`: hỏi đáp thường gặp, việc làm, email, tốt nghiệp, thông tin phục vụ sinh viên.
- `general_ictu_rag`: thông tin tổng quan ICTU và nhánh an toàn khi không có tool chuyên biệt phù hợp.
